...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b87458, const void *arg_0xb7b875f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b388c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79e2840), 
int (*key_eq_fn)(void *arg_0xb79e2c88, void *arg_0xb79e2e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78b19b8, int arg_0xb78b1b10);
static double RandomUniform(void );
...
enum KEY_ENUM {
  qD2UjB93kvyULDJMnGNq, qRBX45SQM0vjfzh9W8kD
};
static const char *RANDOM_KEY[2] = { 
"qD2UjB93kvyULDJMnGNq", "qRBX45SQM0vjfzh9W8kD" };
...
typedef TMilli SmartBraceletC$TimerMissing$precision_tag;
typedef sensor_status SmartBraceletC$FakeSensor$val_t;
typedef TMilli SmartBraceletC$TimerPairing$precision_tag;
typedef TMilli SmartBraceletC$TimerSensing$precision_tag;
...
typedef sensor_status /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void SmartBraceletC$TimerMissing$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void SmartBraceletC$AMControl$startDone(error_t error);
#line 138
static void SmartBraceletC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void SmartBraceletC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void SmartBraceletC$AMSend$sendDone(
#line 103
message_t * msg, 
...
SmartBraceletC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
static void SmartBraceletC$FakeSensor$readDone(error_t result, SmartBraceletC$FakeSensor$val_t val);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$TimerPairing$fired(void );
#line 83
static void SmartBraceletC$TimerSensing$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
static error_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$TimerMissing$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBraceletC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t SmartBraceletC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
SmartBraceletC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t SmartBraceletC$FakeSensor$read(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t SmartBraceletC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool SmartBraceletC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$TimerPairing$startPeriodic(uint32_t dt);
#line 78
static void SmartBraceletC$TimerPairing$stop(void );
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t SmartBraceletC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SmartBraceletC$AMPacket$destination(
#line 74
message_t * amsg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$TimerSensing$startPeriodic(uint32_t dt);
# 28 "SmartBraceletC.nc"
bool SmartBraceletC$busy[1000];
uint16_t SmartBraceletC$counter[1000];

message_t SmartBraceletC$packet[1000];
am_addr_t SmartBraceletC$address_coupled_device[1000];

uint8_t SmartBraceletC$attempt[1000];


uint8_t SmartBraceletC$phase[1000];


bool SmartBraceletC$sensors_read_completed[1000];

sensor_status SmartBraceletC$status[1000];
sensor_status SmartBraceletC$last_status[1000];
...
static void SmartBraceletC$send_confirmation(void );
static void SmartBraceletC$send_info_message(void );


static inline void SmartBraceletC$Boot$booted(void );




static inline void SmartBraceletC$AMControl$startDone(error_t err);
#line 71
static inline void SmartBraceletC$AMControl$stopDone(error_t err);
...
static inline void SmartBraceletC$TimerPairing$fired(void );
#line 98
static inline void SmartBraceletC$TimerSensing$fired(void );




static inline void SmartBraceletC$TimerMissing$fired(void );
...
static void SmartBraceletC$AMSend$sendDone(message_t *bufPtr, error_t error);
#line 154
static inline message_t *SmartBraceletC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 191
static inline void SmartBraceletC$FakeSensor$readDone(error_t result, sensor_status status_local);
#line 222
static void SmartBraceletC$send_confirmation(void );
#line 244
static void SmartBraceletC$send_info_message(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask(void );
# 12 "FakeSensorP.nc"
enum /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_unnamed4341 {
#line 12
  FakeSensorP$0$readDone = 7U
};
#line 12
typedef int /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_sillytask_readDone[/*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone];


static inline error_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$TimerMissing$startOneShot(uint32_t dt){
#line 73
...
#line 73
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SmartBraceletC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
inline static void SmartBraceletC$TimerPairing$stop(void ){
#line 78
...
#line 78
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SmartBraceletC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 88
# 154 "SmartBraceletC.nc"
static inline message_t *SmartBraceletC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len)
#line 154
{
  sb_msg_t *mess = (sb_msg_t *)payload;

  sim_log_debug(164U, "Radio_rec", "Message received from node %hhu at time %s\n", SmartBraceletC$AMPacket$source(bufPtr), sim_time_string());
  sim_log_debug(165U, "Radio_pack", "Payload: type: %hu, msg_id: %hhu, data: %s\n", __nesc_ntoh_uint8(mess->msg_type.nxdata), __nesc_ntoh_uint16(mess->msg_id.nxdata), mess->data);

  if (SmartBraceletC$AMPacket$destination(bufPtr) == AM_BROADCAST_ADDR && SmartBraceletC$phase[sim_node()] == 0 && strcmp(mess->data, RANDOM_KEY[TOS_NODE_ID / 2]) == 0) {



      SmartBraceletC$address_coupled_device[sim_node()] = SmartBraceletC$AMPacket$source(bufPtr);
      SmartBraceletC$phase[sim_node()] = 1;
      sim_log_debug(166U, "Radio_pack", "Message for pairing phase 0 received. Address: %hhu\n", SmartBraceletC$address_coupled_device[sim_node()]);
      SmartBraceletC$send_confirmation();
    }
  else {
#line 169
    if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && __nesc_ntoh_uint8(mess->msg_type.nxdata) == 1) {

        sim_log_debug(167U, "Radio_pack", "Message for pairing phase 1 received\n");
        SmartBraceletC$TimerPairing$stop();
      }
    else {
#line 174
      if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && __nesc_ntoh_uint8(mess->msg_type.nxdata) == 2) {

          sim_log_debug(168U, "Radio_pack", "INFO message received\n");
          sim_log_debug(169U, "Info", "Position X: %hhu, Y: %hhu\n", __nesc_ntoh_uint16(mess->X.nxdata), __nesc_ntoh_uint16(mess->Y.nxdata));
          sim_log_debug(170U, "Info", "Sensor status: %s\n", mess->data);
          SmartBraceletC$last_status[sim_node()].X = __nesc_ntoh_uint16(mess->X.nxdata);
          SmartBraceletC$last_status[sim_node()].Y = __nesc_ntoh_uint16(mess->Y.nxdata);
          SmartBraceletC$TimerMissing$startOneShot(60000);

          if (strcmp(mess->data, "FALLING") == 0) {
              sim_log_debug(171U, "Info", "ALARM: FALLING!\n");
            }
        }
      }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7652ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7652ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = SmartBraceletC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7652ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t SmartBraceletC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74cf730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74cf730, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(176U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(177U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(178U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(179U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7652108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7652108, msg, error);
#line 110
}
#line 110
...
inline static bool SmartBraceletC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 53
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$TimerSensing$startPeriodic(uint32_t dt){
#line 64
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb764f178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb764f178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBraceletC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$TimerPairing$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 59 "SmartBraceletC.nc"
static inline void SmartBraceletC$AMControl$startDone(error_t err)
#line 59
{
  if (err == SUCCESS) {
      sim_log_debug(148U, "Radio", "Radio device ready\n");
      sim_log_debug(149U, "Pairing", "Pairing phase started\n");


      SmartBraceletC$TimerPairing$startPeriodic(250);
    }
  else 
#line 66
    {
      SmartBraceletC$AMControl$start();
    }
}
...
#line 113
  SmartBraceletC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SmartBraceletC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmartBraceletC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74d4ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74d4ca8) {
#line 100
    case 0U:
#line 100
      /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74d4ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 191 "SmartBraceletC.nc"
static inline void SmartBraceletC$FakeSensor$readDone(error_t result, sensor_status status_local)
#line 191
{
  SmartBraceletC$status[sim_node()] = status_local;
  sim_log_debug(172U, "Sensors", "Sensor status: %s\n", SmartBraceletC$status[sim_node()].status);

  if (SmartBraceletC$sensors_read_completed[sim_node()] == FALSE) {

      SmartBraceletC$sensors_read_completed[sim_node()] = TRUE;
    }
  else 
#line 198
    {
      SmartBraceletC$sensors_read_completed[sim_node()] = FALSE;
      SmartBraceletC$send_info_message();
    }

  sim_log_debug(173U, "Sensors", "Position X: %hhu, Y: %hhu\n", status_local.X, status_local.Y);
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  SmartBraceletC$FakeSensor$readDone(result, val);
#line 63
}
#line 63
# 21 "FakeSensorP.nc"
...
#line 21
{
  ...
  int random_number = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 10;
...
#line 37
  /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, status);
  status.X = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  status.Y = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb780d650){
#line 75
  switch (arg_0xb780d650) {
#line 75
...
#line 75
      break;
#line 75
    case /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone:
#line 75
      /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$runTask();
#line 75
      break;
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb780d650);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SmartBraceletC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * SmartBraceletC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 78 "SmartBraceletC.nc"
static inline void SmartBraceletC$TimerPairing$fired(void )
#line 78
{
  SmartBraceletC$counter[sim_node()]++;
  sim_log_debug(150U, "TimerPairing", "TimerPairing: timer fired at time %s\n", sim_time_string());
  if (!SmartBraceletC$busy[sim_node()]) {
      sb_msg_t *sb_pairing_message = (sb_msg_t *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t ));


      __nesc_hton_uint8(sb_pairing_message->msg_type.nxdata, 0);
      __nesc_hton_uint16(sb_pairing_message->msg_id.nxdata, SmartBraceletC$counter[sim_node()]);


      strcpy(sb_pairing_message->data, RANDOM_KEY[TOS_NODE_ID / 2]);

      if (SmartBraceletC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
          sim_log_debug(151U, "Radio", "Radio: sending pairing packet, key=%s\n", RANDOM_KEY[TOS_NODE_ID / 2]);
          SmartBraceletC$busy[sim_node()] = TRUE;
        }
    }
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone);
#line 67
...
#line 15
{
  /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$readDone$postTask();
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t SmartBraceletC$FakeSensor$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 55
# 98 "SmartBraceletC.nc"
static inline void SmartBraceletC$TimerSensing$fired(void )
#line 98
{
  sim_log_debug(152U, "TimerSensing", "Sensing: timer fired at time %s\n", sim_time_string());
  SmartBraceletC$FakeSensor$read();
}

static inline void SmartBraceletC$TimerMissing$fired(void )
#line 103
{
  sim_log_debug(153U, "TimerMissing", "TimerMissing: timer fired at time %s\n", sim_time_string());
  sim_log_debug(154U, "Info", "ALERT: MISSING\n");
  sim_log_debug(155U, "Info", "Last known location: %hhu, Y: %hhu\n", SmartBraceletC$last_status[sim_node()].X, SmartBraceletC$last_status[sim_node()].Y);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7352c70){
#line 83
  switch (arg_0xb7352c70) {
#line 83
    case 0U:
#line 83
      SmartBraceletC$TimerPairing$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SmartBraceletC$TimerSensing$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SmartBraceletC$TimerMissing$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7352c70);
#line 83
      break;
#line 83
    }
...
#line 222
{
  ...
  if (!SmartBraceletC$busy[sim_node()]) {
      ...
      SmartBraceletC$PacketAcknowledgements$requestAck(&SmartBraceletC$packet[sim_node()]);

      if (SmartBraceletC$AMSend$send(SmartBraceletC$address_coupled_device[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
          sim_log_debug(174U, "Radio", "Radio: sanding pairing confirmation to node %hhu\n", SmartBraceletC$address_coupled_device[sim_node()]);
          SmartBraceletC$busy[sim_node()] = TRUE;
        }
    }
}
...
#line 55
{
  /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
# 111 "SmartBraceletC.nc"
static void SmartBraceletC$AMSend$sendDone(message_t *bufPtr, error_t error)
#line 111
{
  if (&SmartBraceletC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      sim_log_debug(156U, "Radio_sent", "Packet sent\n");
      SmartBraceletC$busy[sim_node()] = FALSE;

      if (SmartBraceletC$phase[sim_node()] == 1 && SmartBraceletC$PacketAcknowledgements$wasAcked(bufPtr)) {

          SmartBraceletC$phase[sim_node()] = 2;
          sim_log_debug(157U, "Radio_ack", "Pairing ack received at time %s\n", sim_time_string());
          sim_log_debug(158U, "Pairing", "Pairing phase 1 completed for node: %hhu\n\n", SmartBraceletC$address_coupled_device[sim_node()]);


          if (TOS_NODE_ID % 2 == 0) {

              sim_log_debug(159U, "OperationalMode", "Parent bracelet\n");
              SmartBraceletC$TimerMissing$startOneShot(60000);
            }
          else 
#line 127
            {
              ...
              sim_log_debug(160U, "OperationalMode", "Child bracelet\n");
              SmartBraceletC$TimerSensing$startPeriodic(10000);
            }
        }
      else {
#line 133
        if (SmartBraceletC$phase[sim_node()] == 1) {

            sim_log_debug(161U, "Radio_ack", "Pairing ack not received at time %s\n", sim_time_string());
            SmartBraceletC$send_confirmation();
          }
        else {
#line 138
          if (SmartBraceletC$phase[sim_node()] == 2 && SmartBraceletC$PacketAcknowledgements$wasAcked(bufPtr)) {

              sim_log_debug(162U, "Radio_ack", "INFO ack received at time %s\n", sim_time_string());
              SmartBraceletC$attempt[sim_node()] = 0;
            }
          else {
#line 143
            if (SmartBraceletC$phase[sim_node()] == 2) {

                sim_log_debug(163U, "Radio_ack", "INFO ack not received at time %s\n", sim_time_string());
                SmartBraceletC$send_info_message();
              }
            }
          }
...
# 244 "SmartBraceletC.nc"
static void SmartBraceletC$send_info_message(void )
#line 244
{


  if (SmartBraceletC$attempt[sim_node()] < 3) {
      SmartBraceletC$counter[sim_node()]++;
      if (!SmartBraceletC$busy[sim_node()]) {
          sb_msg_t *sb_pairing_message = (sb_msg_t *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t ));
          ...
          __nesc_hton_uint16(sb_pairing_message->X.nxdata, SmartBraceletC$status[sim_node()].X);
          __nesc_hton_uint16(sb_pairing_message->Y.nxdata, SmartBraceletC$status[sim_node()].Y);
          strcpy(sb_pairing_message->data, SmartBraceletC$status[sim_node()].status);


          SmartBraceletC$attempt[sim_node()]++;
          SmartBraceletC$PacketAcknowledgements$requestAck(&SmartBraceletC$packet[sim_node()]);

          if (SmartBraceletC$AMSend$send(SmartBraceletC$address_coupled_device[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
              sim_log_debug(175U, "Radio", "Radio: sanding INFO packet to node %hhu, attempt: %d\n", SmartBraceletC$address_coupled_device[sim_node()], SmartBraceletC$attempt[sim_node()]);
              SmartBraceletC$busy[sim_node()] = TRUE;
            }
        }
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletC$busy"))
  {
    *addr = (uintptr_t)&SmartBraceletC$busy[__nesc_mote];
    *size = sizeof(SmartBraceletC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$counter"))
  {
    *addr = (uintptr_t)&SmartBraceletC$counter[__nesc_mote];
    *size = sizeof(SmartBraceletC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$packet"))
  {
    *addr = (uintptr_t)&SmartBraceletC$packet[__nesc_mote];
    *size = sizeof(SmartBraceletC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$address_coupled_device"))
  {
    *addr = (uintptr_t)&SmartBraceletC$address_coupled_device[__nesc_mote];
    *size = sizeof(SmartBraceletC$address_coupled_device[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$attempt"))
  {
    *addr = (uintptr_t)&SmartBraceletC$attempt[__nesc_mote];
    *size = sizeof(SmartBraceletC$attempt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$phase"))
  {
    *addr = (uintptr_t)&SmartBraceletC$phase[__nesc_mote];
    *size = sizeof(SmartBraceletC$phase[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$sensors_read_completed"))
  {
    *addr = (uintptr_t)&SmartBraceletC$sensors_read_completed[__nesc_mote];
    *size = sizeof(SmartBraceletC$sensors_read_completed[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$status"))
  {
    *addr = (uintptr_t)&SmartBraceletC$status[__nesc_mote];
    *size = sizeof(SmartBraceletC$status[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$last_status"))
  {
    *addr = (uintptr_t)&SmartBraceletC$last_status[__nesc_mote];
    *size = sizeof(SmartBraceletC$last_status[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SmartBraceletC */
  SmartBraceletC$busy[__nesc_mote] = FALSE;
  SmartBraceletC$counter[__nesc_mote] = 0;
  memset((void *)&SmartBraceletC$packet[__nesc_mote], 0, sizeof SmartBraceletC$packet[__nesc_mote]);
  memset((void *)&SmartBraceletC$address_coupled_device[__nesc_mote], 0, sizeof SmartBraceletC$address_coupled_device[__nesc_mote]);
  SmartBraceletC$attempt[__nesc_mote] = 0;
  SmartBraceletC$phase[__nesc_mote] = 0;
  SmartBraceletC$sensors_read_completed[__nesc_mote] = FALSE;
  memset((void *)&SmartBraceletC$status[__nesc_mote], 0, sizeof SmartBraceletC$status[__nesc_mote]);
  memset((void *)&SmartBraceletC$last_status[__nesc_mote], 0, sizeof SmartBraceletC$last_status[__nesc_mote]);
