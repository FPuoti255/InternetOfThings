...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b35458, const void *arg_0xb7b355f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ae68c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7990840), 
int (*key_eq_fn)(void *arg_0xb7990c88, void *arg_0xb7990e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb785f9b8, int arg_0xb785fb10);
static double RandomUniform(void );
...
static void sendAckC$AMSend$sendDone(message_t *bufPtr, error_t err);
#line 166
static inline message_t *sendAckC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 201
...
#line 166
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_debug(159U, "Common", "Mote%d received packet of wrong length. exiting..\n", TOS_NODE_ID);
      return bufPtr;
    }
  else 
#line 180
    {
      ...
      if (TOS_NODE_ID == 1) {
          sim_log_debug(160U, "Mote1", "Received  RESP for packet with counter %hu: value = %hu\n", __nesc_ntoh_uint16(msg->counter.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
          return bufPtr;
        }
      else {

          if (__nesc_ntoh_uint8(msg->type.nxdata) == 1) {
              sim_log_debug(161U, "Mote2", "Sending the response to request with counter = %hu.\n", __nesc_ntoh_uint16(msg->counter.nxdata));
              sendAckC$counter[sim_node()] = __nesc_ntoh_uint16(msg->counter.nxdata);
              sendAckC$sendResp();
              return bufPtr;
            }
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7603ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7603ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7603ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7600178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7600178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(151U, "Common", "Antenna succesfully started!\n");
      if (TOS_NODE_ID == 1) {
...
#line 105
    {
      sim_log_debug(152U, "Common", "Failed to start the antenna, retrying..\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7603108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7603108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7310ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7310ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7310ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77bb650){
#line 75
  switch (arg_0xb77bb650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77bb650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb730d730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb730d730, addr, msg, len);
#line 80
...
#line 211
  ...
  __nesc_hton_uint16(msg->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint8(msg->value.nxdata, data);

  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) != SUCCESS) {
      sim_log_debug(162U, "Mote2", "Cannot request acks for packet. exiting..\n");
      return;
    }
...
#line 48
{
  ...
  if (sendAckC$locked[sim_node()]) {
      sim_log_debug(148U, "Mote1", "Locked antenna. exiting.. %hu.\n", sendAckC$counter[sim_node()]);
      return;
    }
  else 
#line 62
...
#line 64
      ...
      if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) != SUCCESS) {
          sim_log_debug(149U, "Mote1", "Cannot request acks for packet. exiting..%hu.\n", sendAckC$counter[sim_node()]);
          return;
        }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73653a8){
#line 83
  switch (arg_0xb73653a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73653a8);
#line 83
      break;
#line 83
    }
...
#line 122
{
  ...
  if (&sendAckC$packet[sim_node()] == bufPtr) {
      sendAckC$locked[sim_node()] = FALSE;

      if (TOS_NODE_ID == 1) {
          sim_log_debug(153U, "Mote1", "REQ sent, counter: %hu.\n", sendAckC$counter[sim_node()]);
        }
      else 
#line 138
        {
          sim_log_debug(154U, "Mote2", "RESP sent, counter: %hu.\n", sendAckC$counter[sim_node()]);
        }
    }
  else 
    {
      sim_log_debug(155U, "Common", "Mote%d Error, request not sent. retrying..!", TOS_NODE_ID);
      return;
    }

  if (sendAckC$PacketAcknowledgements$wasAcked(&sendAckC$packet[sim_node()])) {

      if (TOS_NODE_ID == 1) {
          sendAckC$req_id[sim_node()]++;
          sim_log_debug(156U, "Mote1", "Ack number %hu received.\n", sendAckC$req_id[sim_node()]);

          if (sendAckC$req_id[sim_node()] == 6) {
              sendAckC$MilliTimer$stop();
              sim_log_debug(157U, "Mote1", "Timer stopped\n");
            }
        }
      else 
#line 158
        {
          sim_log_debug(158U, "Mote2", "RESP acked.\n");
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$req_id"))
  {
    *addr = (uintptr_t)&sendAckC$req_id[__nesc_mote];
    *size = sizeof(sendAckC$req_id[__nesc_mote]);
    return 0;
  }
