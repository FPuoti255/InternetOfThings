...
sys.stdout = open('simulation.log', 'w')
...
print "Activate debug message on channel send_req"
t.addChannel("Mote1",out);
print "Activate debug message on channel mote2"
t.addChannel("Mote2",out);
print "Activate debug message on channel common"
t.addChannel("Common", out);
